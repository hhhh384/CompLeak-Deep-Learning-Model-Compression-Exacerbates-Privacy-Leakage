...
def main(args):
    ...
    print("Start Six Membership Inference Attacks as CompLeakNR")
    attacker = MiaAttack(
    ...
    print("-------------------------")
    print("Starting SAMIA MIA")
    attacker.CompLeakNR_SAMIA()
    print("-------------------------")

    print("Starting metric_based MIA")
    attacker.CompLeakNR_metric_based()
    print("-------------------------")
    
    print("Starting train_based MIA")
    attacker.CompLeakNR_train_based()
    print("-------------------------")

    print("Starting RMIA MIA")
    attacker.CompLeakNR_RMIA()
    print("Finish CompLeakNR (Six Membership Inference Attacks) ")
